<?php 
   ...
   if(isset($_POST['name']))
   {
    ...
    $sql = "INSERT INTO `dbms`.`book_car`  (`Custname` , `model` , `address` , `License` ,`startdate`, `returndate`)
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>4WheelerBooking</title>
        <link href="FourWheelBook.css" rel="stylesheet">
    </head>
    <body>
    ...
    <a href="Payment_car.php">
    <div class="pay">
         <strong> Make<br>
            Payment</strong>
      </div></a>
    <h1 class="heading" >FOUR WHEELERS SECTION</h1>
        ...
        <form method="post" >
          <table cellspacing=20px>
           <tr> 
            ...
            <tr>
            <td><label>Enter ReturnDate</label></td>
