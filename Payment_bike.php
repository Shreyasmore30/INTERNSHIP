...
require('Config.php');
      ...
      $sql_amt = "SELECT `TOTALCOST_BIKE`('$bid' , '$model' , '$mode');";
      $sql_row = "SELECT * FROM `payment_bike` WHERE `BookingID`='$bid';";
      // if($sql!=NULL)
      // {
      ...
      //  echo "registered";
            ...
            while($bikecursor = mysqli_fetch_array($result_row))
            {
                echo "<br>";
                
                echo "<br><strong>PaymentID : </strong>" . $bikecursor['PaymentID']."<br><strong>BookingID :</strong>" . $bikecursor['BookingID'] . "<br><strong>modelnumber :</strong>" . $bikecursor['modelnumber'] ."<br><strong>Number OF Days: </strong> ".$bikecursor['Days_booked']. "<br><strong>Amount : RS </strong>" . $bikecursor['Amount'] . "<br><strong>Mode of Payment :</strong>" . $bikecursor['Payment_type']; 
